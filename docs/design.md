...
| Flow action | Left of the utilities, filled | At most one, and only where the surface has one to offer: geolocate an open request, or signal that you are working on it. |
