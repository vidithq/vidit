...
| P0 | Vitrine | "Before public launch" copy on `/about` reads stale on an already-public page | [`about/page.tsx:238`](../frontend/src/app/about/page.tsx:238) — "A full legal terms-of-service and privacy policy will land before public launch" sits on a page reachable without an account. The intended gate is M3 (open registration), not "public visibility." Reword to "before open registration" or "before Phase 3" so cold visitors don't read it as a pre-launch placeholder left in. |
