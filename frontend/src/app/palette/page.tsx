    ...
    >
      <div className="space-y-8">
        ...
        <section className="space-y-3">
          ...
          <Item name="<ActivityHeatmap>" usage="Contribution grid at month resolution (profile insights): one row per calendar year, twelve month cells, intensity off the busiest month. Months rather than days, because an analyst publishes tens of events a year and a daily grid would be blank almost everywhere. A lit month is a control: hover, tap or focus it and the line under the grid names it and its count. Empty months keep the absence paint and take no focus stop, so the accent marks exactly what answers. The focus ring is the accent's 500 stop rather than a paler one, since light mode repoints the neutral scale and leaves the accent alone, so a pale ring vanishes on the near-white card. No dated event renders a sentence; a single month keeps the grid, since the empty cells beside the lit one are what say which month it was.">
            <div className="w-full max-w-sm space-y-4">
              <ActivityHeatmap
                buckets={[
